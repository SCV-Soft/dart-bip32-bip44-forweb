...
import 'package:bip32_bip44/src/crypto.dart';
...
void main() {
  ...
  [vector1, vector2, vector3].forEach((vector) {
    test('static vector', () {
      ...
      vector['chains'].forEach((child) {
        var privateKey = chain.forPath(child['chain']) as ExtendedPrivateKey;
  ...
  test('refuse to generate a hardened child for a extended public key', () {
    var parent = ExtendedKey.deserialize(vector2['chains'][0]['publicKey'])
